...
export default function page() {
    ...
    return (
        <div className='w-full min-h-screen flex justify-center items-center bg-black'>
            <form className=' w-full max-w-lg p-8 bg-white rounded-3xl'>
                ...
                <button className='w-full h-12 bg-black/90 cursor-pointer active:bg-black/80 text-white mt-5 rounded-2xl'>Sign in</button>
