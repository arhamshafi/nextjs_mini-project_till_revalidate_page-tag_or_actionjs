            ...
            <StyledWrapper>
                <form onSubmit={SubmitForm} className="form">
                    ...
                    <div className="flex-row">
                        ...
                        <span className="span text-center w-full">Forgot password?</span>
                    </div>
                    <button className="button-submit">Log in</button>
                    <p className="p">Don't have an account? <span className="span" onClick={() => router.push("/signup")} >Sign Up</span>
                    </p><p className="p line">Or With</p>
                    <div className="flex-row">
                        <button className="btn google" onClick={() => toast.info("This feature is coming soon!")}>
                            <svg
                        ...
                        <button className="btn apple" onClick={() => toast.info("This feature is coming soon!")} >
